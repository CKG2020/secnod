...
//        //获得基本的信息
//        System.out.println(FileUtils.getTempDirectory());//获取临时目录 java.io.tmpdir,getUserDirectoryPath返回路径字符串     结果: /tmp
//        System.out.println(FileUtils.getUserDirectory());//获取用户主目录 user.home,getUserDirectoryPath返回路径字符串           /home/ckg
//
...
//    }
    ...
    public void FileOperation() throws IOException {
        ...
        FileUtils.touch(new File("/home/ckg/Desktop"));
